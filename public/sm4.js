...
export function SM4Util() {
    this.secretKey = 'HuanBaoSm4Code12';
    this.iv = '';
...
export let stringToByte = function (str) {
    var bytes = new Array();
    var len, c;
    len = str.length;
    for (var i = 0; i < len; i++) {
...
export let byteToString = function (arr) {
...
export function encryptData_ECB(e) {
    return s4.encryptData_ECB(e);
}

export function encryptData_CBC(e) {
    s4.iv = 'UISwD9fW6cFh9SNS';
    return s4.encryptData_CBC(e);
}
